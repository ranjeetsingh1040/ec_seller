...
<span class="mx-2">
 <a @click="enableform(attributesetid)" class="" data-toggle="tooltip" title="Edit"><img src="~/static/assets/img/edit.svg" class="w-4 h-4">
 </a> 
 </span>
 <!-- <span class="mx-2">
        <nuxt-link  :to="{name: 'seller-editattributeset',params:{attributesetid:attributeset.id}}" data-toggle="tooltip" title="Edit" ><img src="~/static/assets/img/edit.svg" class="w-4 h-4">
        </nuxt-link>
        </span> -->
      </p>
    </portal>
                ...
                <form action="#" @submit.prevent="store">
                  ...
                  <div class="columns">
                    <div class="field column is-6">
                      ...
                      <div class="control">
                        <input class="input" type="text" :class="{ 'is-danger': errors.name }" v-model="attributeset.name"
                          autofocus="">
               ...
               v-model="form.status" :class="{ 'is-danger': errors.status }" 
                          ...
                          <!-- <div class="onoffswitch">
                            <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox"
                              v-model="attributeset.status" id="myonoffswitch">
                          ...
                          <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" value="" class="sr-only peer" v-model="attributeset.status" id="myonoffswitch">
                            <div
