...
<span class="mx-2">
 <a @click="enableform(categoryid)" :to="{name: 'seller-editcategory',params:{categoryid:category.id}}"  class="" data-toggle="tooltip" title="Edit"><img src="~/static/assets/img/edit.svg" class="w-4 h-4">
 </a>
 </span>
 </p>
</portal>
