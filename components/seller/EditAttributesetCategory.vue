...
<p slot-scope="{id}"><!-- {{id}}  -->
    <span class="mx-2">
     <!-- <a @click="enableform()" :to="{name: 'seller-editattributesetcategory',params:{id:attributesetcategory.id,category_id:attributesetcategory.category_attributeset.id}}"  class="" data-toggle="tooltip" title="Edit"><img src="~/static/assets/img/edit.svg" class="w-4 h-4">
     </a> -->
     <a @click="enableform(id)" class="" data-toggle="tooltip" title="Edit"><img src="~/static/assets/img/edit.svg" class="w-4 h-4">
     </a> 
     </span>
</p>
</portal>
