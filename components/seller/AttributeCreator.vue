<template>
  <div id="app">
    ...
    <h1 class="pb-2 font-bold mt-16">Add Attributes</h1>
    <form action="#" @submit.prevent="store" class="custom-form ">
      ...
      <div v-if="this.success != null" class="w-1/2  my-4 bg-red-500 p-4 border border-red-500 text-red-700 px-4 py-3 rounded relative" role="alert">
          ...
          <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              ...
              <div class="select is-fullwidth w-full lg:w-3/4">
                <select @change="changed" v-model="form.attributeset_id" :class="{ 'is-danger': errors.attributeset_id }">
            ...
            :class="{ 'is-danger': errors.attribute_code }">
               ...
               <option value="Weight">Weight</option>
                ...
                <input class="input" type="text" :class="{ 'is-danger': errors.attribute_code }"
                  v-model="form.attribute_code" autofocus="" style="text-transform: lowercase;">
            ...
            <div class="field column flex flex-col lg:flex-row">
              ...
              <div class="control w-full lg:w-3/4">
                <input class="input" type="text" :class="{ 'is-danger': errors.attribute_label }"
                  v-model="form.attribute_label" autofocus="">
          ...
          <div class="columns">
            <div class="field column is-6">
              <div class="control flex flex-col lg:flex-row leading-normal">
                ...
                <div>
                  <input type="checkbox" id="variation" v-model="form.variation" v-on:click="isdropdown = !isdropdown">
