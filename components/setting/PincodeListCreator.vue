        ...
        <div class="w-full lg:w-3/5">
          ...
          <div class="columns mb-2 lg:mb-10">
            <div class="column">
              <div class="field flex flex-col lg:flex-row">
                ...
                <div class="control w-full lg:w-3/4">
                  <input class="input" :class="{ 'is-danger': errors.pincode }" type="text" v-model="form.pincode"
                    autofocus="">
          ...
          <!-- <div class="columns mb-2 lg:mb-10">
            <div class="field column  flex flex-col lg:flex-row">
              ...
              <div class="control w-full lg:w-3/4">
                <input class="input" :class="{ 'is-danger': errors.city }" type="text" v-model="form.city" autofocus="">
          ...
          <!-- <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              ...
              <div class="control  w-full lg:w-3/4">
                <input class="input" :class="{ 'is-danger': errors.district }" type="text" v-model="form.district"
                  autofocus="">
          ...
          <!-- <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              ...
              <div class="control  w-full lg:w-3/4">
                <input class="input" :class="{ 'is-danger': errors.state }" type="text" v-model="form.state"
                  autofocus="">
          ...
          <!-- <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              <label class="label w-full lg:w-1/4">City</label>
              <div class="control  w-full lg:w-3/4">
                <StateDropdown v-model="form.city_id" />
                <p class="help is-danger" v-if="errors.city_id">
                  {{ errors.city_id[0] }}
                </p>
              </div>
            </div>
          ...
          <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              <label class="label w-full lg:w-1/4">State</label>
              <div class="control  w-full lg:w-3/4">
                <StateDropdown v-model="form.state_id" />
                <p class="help is-danger" v-if="errors.state_id">
                  {{ errors.state_id[0] }}
                </p>
              </div>
            </div>
          ...
          <div class="columns mb-2 lg:mb-10">
            <div class="field column flex flex-col lg:flex-row">
              ...
              <div class="control  w-full lg:w-3/4">
                <input class="input" :class="{ 'is-danger': errors.delivered }" type="number" v-model="form.delivered"
                  autofocus="">
