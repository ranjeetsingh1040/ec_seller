  ...
  <div id="app">
    ...
    <div v-bind:class="[this.product_tab == 1 ? 'block' : 'hidden']">
      <form action="#" @submit.prevent="store" class="custom-form" enctype="multipart/form-data">
        ...
        <div v-if="this.success != null" class="w-1/2 p-4 mb-8 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
          <span class="block sm:inline" v-html="success">{{this.success}}.</span>
          ...
          <div class="w-full lg:w-3/5">
            ...
            <div class="columns mb-2 lg:mb-10">
              <div class="field column flex flex-col lg:flex-row">
                ...
                <div class="control w-full lg:w-3/4">
                  <input class="input" type="text" :class="{ 'is-danger': errors.brand }" v-model="form.brand"
                    autofocus="">
            ...
            <div class="columns mt-2 lg:mt-0 mb-2 lg:mb-10">
              <div class="field column flex">
                ...
                <label class="relative inline-flex  cursor-pointer">
                  <input type="checkbox" value="" class="sr-only peer" id="myonoffswitch" v-model="form.status"
                    :class="{ 'is-danger': errors.status }" checked>
                  <div
            ...
            <div class="columns mb-2 lg:mb-10 ">
              <div class="field column flex flex-col lg:flex-row ">
                ...
                <div class="control w-full lg:w-3/4">
                  ...
                  <input class="input" type="number" :class="{ 'is-danger': errors.price }" v-model="form.price"
                    autofocus="" min="0">
            ...
            <div class="columns mb-2 lg:mb-10">
              <div class="field column flex flex-col lg:flex-row">
                ...
                <div class="control w-full lg:w-3/4">
                  ...
                  <input class="input" type="number" :class="{ 'is-danger': errors.weight }" v-model="form.weight"
    ...
    s1.535-0.293,2.121-0.879c1.172-1.171,1.172-3.071,0-4.242L28.228,23.986z">
            ...
            <div class="dropzone-img">
              <dropzone id="foo" ref="el" :options="options" :destroyDropzone="true" v-on:vdropzone-success="showSuccess"
                v-on:vdropzone-sending="sendingEvent" v-on:vdropzone-thumbnail="showthumbnail" required></dropzone>
      ...
      let response = await this.$axios.$post('products/addproducts', formData,
        {
          ...
          if (response.message !== "Product Saved Successfully") {
            ...
            this.$nuxt.$emit('productprice', this.productprice);
