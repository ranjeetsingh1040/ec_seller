<template>
  <div id="app">
   ...
   <div v-if="this.success!=null" class="w-1/2 my-4 bg-green-500 p-4" id="success-alert"><p class="text-white">{{this.success}}</p></div>
 <!--   <div v-if="this.success!=null" class="w-1/2 my-4 bg-red-500 p-4" id="success-alert"><p class="text-white">{{this.success}}</p></div> -->
          ...
          <div class="flex my-2">
            ...
            <div class="flex justify-between">
                <div class="flex self-center my-6">
                      ...
                      <a href="#" @click="edit()" class="text-sm no-underline bg-gray-900 px-4 py-2 text-white rounded-full flex items-center justify-center hover:bg-black uppercase mr-4">Save</a>
        ...
        async edit () {
             ...
             async getaddressdetails(id)
              ...
              changed ($event) {
               ...
               async getStates() {
                let response = await this.$axios.$get('states',+country_id)
