<template>
  <div id="app">
    ...
    <h1 class="pb-2 font-bold mt-16">Create a Store</h1>
    <div v-if="this.success != null" class="w-1/2 my-4 bg-red-500 p-4" id="success-alert">
      <p class="text-white">{{ this.success }}</p>
    </div>

    <!--   <div  class="w-1/2 my-4 bg-red-500 p-4" id="success-alert"><p class="text-white">aaaaaaaaaaaaaaa</p></div> -->
...
<!-- 
              ...
              <label class="relative inline-flex justify-center cursor-pointer">
                <input type="checkbox" name="onoffswitch" value="" class="sr-only peer onoffswitch-checkbox"
                  id="myonoffswitch" v-model="form.status" :class="{ 'is-danger': errors.status }">
                <div
                  class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-red-500 dark:peer-focus:ring-red-500 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-red-600">
                </div>
          ...
          <div class="columns mb-2 lg:mb-10">
            <div class="column">
              <div class="field flex flex-col lg:flex-row">
                ...
                <div class="control w-full lg:w-3/4">
                  <textarea class="form-control" rows="5" cols="50" :class="{ 'is-danger': errors.description }"
...
export default {
  ...
  methods: {
    ...
    async store() {
      ...
      //  debugger;
      let responses = await this.$axios.$post('stores/addstores', formData, {
        headers: {
