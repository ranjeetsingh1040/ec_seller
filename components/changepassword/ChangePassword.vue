    ...
    <div class="w-full  p-10">
      ...
      <form action="" @submit.prevent="store" class="custom-form">
        <div class="flex flex-col lg:flex-row md:flex-row">
          <div class="w-full lg:w-1/2 flex my-4 bg-transparent border-b border-gray-500 p-4 mr-4">
            <i class="fa fa-lock fa1" aria-hidden="true"></i>
            <div class="control">
              <input class="outline-none ml-4 bg-transparent w-full" type="password" v-model="form.oldpassword"
          ...
          <div class="w-full lg:w-1/2 flex my-4 bg-transparent border-b border-gray-500 p-4">
            <i class="fa fa-lock fa1" aria-hidden="true"></i>
            <div class="control">
              <input class="outline-none ml-4 bg-transparent w-full" type="password" v-model="form.newpassword"
        ...
        <div class="flex flex-col lg:flex-row w-full">
          <div class="w-full lg:w-1/2 mr-4 flex my-4 bg-transparent border-b border-gray-500 p-4">
            <i class="fa fa-lock fa1" aria-hidden="true"></i>
            <div class="control">
              <input class="outline-none ml-4 bg-transparent w-full" type="password" v-model="form.confirmpassword"
