<template>
	<div class="page dashboard--page">
		<h1 class="pb-2 font-bold mt-16	">Dashboard</h1>
	<div class="my-3">
		<div class="flex flex-wrap">
		   <div class="w-full md:w-1/4 lg:w-1/4 flex">
		   	<div class="py-4 bg-white px-4 shadow-md my-2 rounded w-full" style="box-shadow: 0 1px 1px rgba(0,0,0,.05);background:linear-gradient(to right, #ffbc59 0%, #fdca7c 100%);">
		   
		   	<div class="flex justify-between w-full">
		   		<p class="font-medium text-base text-white tracking-wide">Products</p>
		   		<div class="">
		  	<select class="text-black text-xs border bg-white p-1 rounded">
		   	...
		   	<div class="flex items-center justify-between pt-4">
		  		<img src="~/static/assets/img/product.svg" class="w-8 h-8" style="filter:brightness(0) invert(1);">
		  		<p class="text-white text-3xl italic">{{productcount}}</p>
		  	</div>
		   	</div>
		   </div>
 		   <div class="w-full md:w-1/4 lg:w-1/4 flex">
 		   	<div class="md:mx-2 xs:mx-0  py-4 bg-white px-4 shadow-md my-2 rounded w-full" style="box-shadow: 0 1px 1px rgba(0,0,0,.05);background:linear-gradient(to right, #ff5b77 0%, #ff8097 100%)">
		  	...
		  	<select class="text-black text-xs border bg-white p-1 rounded">
 		   	...
 		   	<div class="flex items-center justify-between pt-4">
		  		<img src="~/static/assets/img/store.svg" class="w-8 h-8" style="filter:brightness(0) invert(1);">
		  		<div class="flex items-center">
		  		<p class="text-white text-3xl ">{{storecount}}</p>
		  		</div>
		  	</div>
 		   	</div>
 		   </div>
 		    ...
 		    <div class="w-full md:w-1/4 lg:w-1/4 flex">
		  	...
		  	<select class="text-black text-xs border bg-white p-1 rounded">
 		   	...
 		   	<div class="flex items-center justify-between pt-4">
		  		<img src="~/static/assets/img/store.svg" class="w-8 h-8" style="filter:brightness(0) invert(1);">
		  		<div class="flex items-center">
		  		<p class="text-white text-3xl ">{{transactionamount}}</p>
		  		</div>
		  	</div>
 		   	</div>
 		   </div>	
 		   ...
 		   <div class="w-full md:w-1/2 lg:w-1/2">
		  	<div class="md:mx-2 xs:mx-0 py-4 bg-white px-4 my-2 rounded" style="box-shadow: 0 1px 1px rgba(0,0,0,.05);background:linear-gradient(to right, #36daba 0%, #54dfc2 100%)">
		  	...
		  	<select class="text-black text-xs border bg-white p-1 rounded">
		  		...
		  		<div class="w-1/3">
		  		<img src="~/static/assets/img/order.svg" class="w-8 h-8" style="filter:brightness(0) invert(1);">
		  		</div>
		  		<div class="flex w-2/3 justify-between">
		  			...
		  			<div class="text-white leading-normal border-r  border-white text-center w-1/4">
		  			<p class="text-2xl font-semibold ">{{ordercompletedcount}}</p>
		  			<p class="text-xs">Completed</p>
		  			</div>
		  			<div class="text-white leading-normal  border-r  border-white text-center w-1/4">
		  			<p class="text-2xl font-semibold ">{{orderprocessingcount}}</p>
		  			<p class="text-xs">Processing</p>
		  			</div>
		  			<div class="text-white leading-normal  text-center w-1/4">
		  			<p class="text-2xl font-semibold ">{{ordercancelcount}}</p>
   ...
   <div class="flex flex-col lg:flex-row my-3">
	<div class="w-full md:w-1/2 lg:w-1/2 md:mx-2 xs:mx-0">
	<no-ssr>
		 <ChartBar />
		 </no-ssr>
	</div>
	<div class="w-full md:w-1/2 lg:w-1/2 md:mx-2 xs:mx-0">
	 ...
	 <div class="w-full md:w-1/2 lg:w-1/2 md:mx-2 xs:mx-0">
		...
		<div class="bg-card  md:mx-2 xs:mx-0">
	...
	<div class="flex flex-col lg:flex-row my-3 overflow-x-scroll">
		<div class="w-full mx-2">
		<p class="font-medium text-sm uppercase text-gray-900 tracking-wide mb-3">Recent Orders</p>
		 ...
		 <th><p>Order #</p></th>
		  ...
		  <th><p>Amount</p></th>
		   ...
		   <tbody class="text-sm text-gray-900">
		   	 <tr v-for="order in orderlists" :key="order.id">
		   	 	 <td><p class="text-sm text-gray-900">
	              ...
	              class="order-a"  title="View">{{order.orderno}}
					...
					<td>
						<div>
				        <p class="text-sm font-semibold flex items-center text-gray-900">
                   	    <img src="~/static/assets/img/rupee-indian.svg" class="w-3 h-3 mx-1" > 
				...
				<!-- <tbody class="text-sm text-gray-900">
				<tr>
					<td><p class="text-sm text-gray-900">OR#001</p></td>
					<td>
						<div class="flex items-center">
				...
				<tr>
					<td><p class="text-sm text-gray-900">OR#002</p></td>
					<td>
						<div class="flex items-center">
				...
				<tr>
					<td><p class="text-sm text-gray-900">OR#003</p></td>
					<td>
						<div class="flex items-center">
				...
				<tr>
					<td><p class="text-sm text-gray-900">OR#004</p></td>
					<td>
						<div class="flex items-center">
					...
					<tr>
					<td><p class="text-sm text-gray-900">OR#005</p></td>
					<td>
						<div class="flex items-center">
			            <a href="#" class="text-sm">Elizabeth W.</a>
			            <p class="text-white text-xs mx-3 rounded px-2 paid leading-normal">Completed</p>
