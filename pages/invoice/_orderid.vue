            ...
            <div class="w-full lg:w-1/2">
              ...
              <div class=" bg-white border  p-3 mb-4 ">
                ...
                <div class="flex mb-2">
                  <div class="w-2/5">
                    <div>
                      <h6 class="mt-0">Purchased From</h6>
                    </div>
                  </div>
                  <div class="w-3/5">
          ...
          <div class="flex flex-col lg:flex-row">
            ...
            <div class="w-full lg:w-1/2 mx-3">
              ...
              <div class="bg-white border p-3 mb-4">
                <div class="mb-2">
                  <div class="leading-loose">
                    <p class="text-sm"><!-- Free shipping - Free --> Total shipping charges: {{ order[0].shippingprice }}
                    </p>
                ...
                <div class="mb-2">
                  <div class="leading-loose flex flex-col items-end">
                    ...
                    <table class="mb-2">
                      <tr>
                        <td class="text-right">
                          <p class="text-sm mr-5">subtotal </p>
                        </td>
                        <td class="text-right">
                          <p class="text-sm">{{ order[0].currency }} {{ pricetotal }}</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="text-right">
                          <p class="text-sm mr-5">shipping price </p>
                        </td>
                        <td class="text-right">
                          <p class="text-sm">{{ order[0].currency }} {{ shippingpricetotal }}</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="text-right">
                          <p class="text-sm mr-5">Tax</p>
                        </td>
                        <td class="text-right">
                          <p class="text-sm">{{ order[0].currency }} {{ overalltaxtotal }}</p>
                        </td>
                      </tr>
                      <tr>
                        <td class="text-right">
                          <p class="text-sm  mr-5">Grand Total</p>
                        </td>
                        <td class="text-right ">
                          <p class="text-sm text-orange">{{ order[0].currency }} {{ overalltotalamount }}</p>
                        </td>
                      </tr>
                    </table>
                    <div class="w-full text-right border-t pt-2">
                      <!--  <p class="text-sm">Append Comments<span class="m-1"><input type="checkbox" name=""/></span></p> -->
                      <p class="text-sm">Email copy of Invoice<span class="m-1"><input type="checkbox" name=""
                            v-model="form.chkemail" checked="" /></span></p>
